...
class TimestampToGuardium(ValueTransformer):
    ...
    # TODO: A slightly more readable way of doing this would be:
    # converted_string = re.sub("\.\d{3}Z$", "", timestamp)
    # converted_string = re.sub("T", " ", converted_string)
...
def get_all_transformers():
    return {"SplunkToTimestamp": SplunkToTimestamp, "EpochToTimestamp": EpochToTimestamp, "ToInteger": ToInteger, "ToString": ToString,
            ...
            "MsatpToRegistryValue": MsatpToRegistryValue, "FormatMac": FormatMac, "Ymd_HMSToTimestamp": Ymd_HMSToTimestamp,
            "TimestampToGuardium": TimestampToGuardium, "GuardiumToTimestamp": GuardiumToTimestamp, "EpochToGuardium": EpochToGuardium}
